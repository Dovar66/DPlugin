...
class ResourceCollector {
    ...
    private DExtention.VAContext vaContext
    ...
    public ResourceCollector(Project project, ProcessAndroidResources par) {
        ...
        sDExtention = project.dpluginConfig
        vaContext = sDExtention.getVaContext(par.variantName)
    ...
    private void reassignPluginResourceId() {
        ...
        resourceIdList.each {
            ...
            pluginResources.get(it.resType).each {
                it.setNewResourceId(sDExtention.packageId, typeId, entryId++)
            }
        }
