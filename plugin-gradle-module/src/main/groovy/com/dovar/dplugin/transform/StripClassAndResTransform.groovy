package com.dovar.dplugin.transform

import com.android.build.api.transform.*
import com.android.build.gradle.api.ApplicationVariant
import com.android.build.gradle.internal.pipeline.TransformManager
import com.dovar.dplugin.DExtention
import com.dovar.dplugin.collector.HostClassAndResCollector
...
class StripClassAndResTransform extends Transform {
    ...
    void onProjectAfterEvaluate() {
        project.android.applicationVariants.each { ApplicationVariant variant ->
            sDExtention.getVaContext(variant.name).checkList.addCheckPoint(name)
        }
    }
    ...
    void transform(final TransformInvocation transformInvocation) throws TransformException, InterruptedException, IOException {
        DExtention.VAContext vaContext = sDExtention.getVaContext(transformInvocation.context.variantName)
